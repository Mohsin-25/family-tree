...
import { useGetLoggedin } from "../auth/logIn/services/service";
import { useGetSignin } from "../auth/signIn/services/service";
...
const NewAuth = () => {
  ...
  return (
    <div className="flex">
      ...
      <div
        id="login-page-form"
        className=" bg-white/40 rounded-xl flex fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 backdrop-filter backdrop-blur-[2px] bg-opacity-10"
      >
